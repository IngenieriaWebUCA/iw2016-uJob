...
import es.uca.iw.ujob.domain.UsersIntegrationTest;
...
privileged aspect UsersIntegrationTest_Roo_IntegrationTest {
    ...
    public void UsersIntegrationTest.testFindUsers() {
        ...
        Assert.assertEquals("Find method for 'Users' returned the incorrect identifier", id, obj.getDni());
    }
    ...
    public void UsersIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Users' identifier to be null", obj.getDni());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Users' identifier to no longer be null", obj.getDni());
    }
