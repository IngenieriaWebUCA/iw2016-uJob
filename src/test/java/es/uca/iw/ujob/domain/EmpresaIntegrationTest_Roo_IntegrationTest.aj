...
import es.uca.iw.ujob.domain.EmpresaIntegrationTest;
...
privileged aspect EmpresaIntegrationTest_Roo_IntegrationTest {
    ...
    public void EmpresaIntegrationTest.testFindEmpresa() {
        ...
        Assert.assertEquals("Find method for 'Empresa' returned the incorrect identifier", id, obj.getCif());
    }
    ...
    public void EmpresaIntegrationTest.testMergeUpdate() {
        ...
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getCif(), id);
    ...
    public void EmpresaIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Empresa' identifier to be null", obj.getCif());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Empresa' identifier to no longer be null", obj.getCif());
    }
