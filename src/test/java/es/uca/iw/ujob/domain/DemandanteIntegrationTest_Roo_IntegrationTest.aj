...
import es.uca.iw.ujob.domain.DemandanteIntegrationTest;
...
privileged aspect DemandanteIntegrationTest_Roo_IntegrationTest {
    ...
    public void DemandanteIntegrationTest.testFindDemandante() {
        ...
        Assert.assertEquals("Find method for 'Demandante' returned the incorrect identifier", id, obj.getDni());
    }
    ...
    public void DemandanteIntegrationTest.testMergeUpdate() {
        ...
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getDni(), id);
    ...
    public void DemandanteIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Demandante' identifier to be null", obj.getDni());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Demandante' identifier to no longer be null", obj.getDni());
    }
