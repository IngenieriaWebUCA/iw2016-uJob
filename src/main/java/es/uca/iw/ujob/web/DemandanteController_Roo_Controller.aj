...
import es.uca.iw.ujob.web.DemandanteController;
...
privileged aspect DemandanteController_Roo_Controller {
    ...
    public String DemandanteController.show(@PathVariable("dni") String dni, Model uiModel) {
    ...
    public String DemandanteController.update(@Valid Demandante demandante, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        demandante.merge();
        return "redirect:/demandantes/" + encodeUrlPathSegment(demandante.getDni().toString(), httpServletRequest);
    }
    
    @RequestMapping(value = "/{dni}", method = RequestMethod.DELETE, produces = "text/html")
    public String DemandanteController.delete(@PathVariable("dni") String dni, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Demandante demandante = Demandante.findDemandante(dni);
        demandante.remove();
        uiModel.asMap().clear();
